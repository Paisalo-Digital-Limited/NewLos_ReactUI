...
const Details = ({ ficode, creator }) => {
  ...
  const addressFields = [
    { section: "Resident Address", fields: ["Current_State", "p_Pincode", "P_Address2", "P_City", "P_Phone", "P_Address3", "residentPhone", "residentPhone2"] },
    { section: "Temporary Address", fields: ["Current_State", "Current_Pincode", "Current_Address1", "Current_City", "Current_Phone", "Current_Address3"] },
  ];
  ...
  const personalDetailsFields = [
    ...
    { label: "Other Identity Type", name: "otherIdentityType", type: "select", options: [
      { label: "Choose...", value: "" },
  ...
  const coBorrowerDetailsFields = [
    ...
    { label: "Relation With Borrower", name: "relationWithBorrower", type: "select", options: [
  ...
  const renderGeneralDetails = () => (
    <Box>
      ...
      {addressFields.map((section, index) => (
        <Box key={index}>
          <Typography variant="subtitle1" gutterBottom>{section.section}</Typography>
  ...
  const renderCoBorrowerDetails = () => (
    <Box>
      <Typography variant="h6" gutterBottom>Co-Borrower Details</Typography>
  ...
  const renderTopUpDetails = () => (
    <Box>
      <Typography variant="h6" gutterBottom>Top-Up Details</Typography>
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case 3: return renderCoBorrowerDetails();
      case 4: return renderTopUpDetails();
      default: return null;
    }
  };
        ...
        <Grid item xs={12} sm={9} md={10}>
          {renderTabContent()}
                ...
                >
                    ...
                    <AnimateButton>
                        <Button variant="contained" color="success" fullWidth sx={{ marginBottom: '10px' }}  onClick={() => setIsEditable((prev) => !prev)}>
