...
<<<<<<< HEAD:src/pages/component-overview/index.jsx
...
function LoanTrackerPage() {
    ...
    const [formData, setFormData] = useState({
        ...
        Bank_IFCS: '',
        Picture:'',
>>>>>>> a118244bc498877007ff11d494ad421d1ac22180:src/pages/fiprocessing/credit/Index/index.jsx
...
=======
    ...
    useEffect(() => {
        const fetchCreators = async () => {
            try {
                const data = await fetchCreatorsApi(); // Assuming this returns an array of creator objects
                setCreators(data);
            } catch (error) {
                console.error(error);
            }
