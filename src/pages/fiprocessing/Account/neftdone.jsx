    ...
    <Box sx={{ p: 2 }}>
          ...
          {['Bulk NEFT Approved', 'NEFT Reject/Return Cases'].map((label) => (
            <Grid item xs={12} sm={6} key={label}>
              ...
              >
                ...
                <Button variant="contained" startIcon={<FileUploadIcon />} sx={{ background: 'linear-gradient(135deg, #9C27B0, #BA68C8)' }}>
                  Upload
                </Button>
                <Button
                  variant="contained"
      ...
      <Card sx={{ p: 2, mb: 2 }}>
        ...
        <Grid container spacing={2} alignItems="center" sx={{ marginTop: '10px' }}>
          ...
          <Grid item xs={12} sm={2}>
            <Button variant="contained" startIcon={<SearchIcon />} onClick={() => {}} sx={{ padding: '10px 12px' }}>
              Search
            </Button>
          </Grid>
