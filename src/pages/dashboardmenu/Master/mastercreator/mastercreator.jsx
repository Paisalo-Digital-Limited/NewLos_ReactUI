    ...
    <ComponentSkeleton>
      <MainCard>
          ...
          <Grid container spacing={2} sx={{ mt: 2 }}>
            {[
              ...
              <Grid key={field.name} item xs={12} md={3}>
                <TextField label={field.label} name={field.name} value={formData[field.name]} fullWidth />
              </Grid>
            ))}
            ...
            <Grid item xs={12} md={3}>
              <FormControl fullWidth>
                ...
                <Select labelId="creatorType-label" id="creatorType-select" value={formData.creatorType} label="Creator Type*">
            ...
            <Grid item xs={12} md={3}>
              <FormControl fullWidth>
                ...
                <Select labelId="creatorFor-label" id="creatorFor-select" value={formData.creatorFor} label="Creator For*">
            ...
            <Grid item xs={12} md={3}>
              <FormControl fullWidth>
                ...
                <Select labelId="zoneName-label" id="zoneName-select" value={formData.zoneName} label="Zone Name*">
            ...
            <Grid item xs={12} md={3}>
              <FormControl fullWidth>
                ...
                <Select labelId="stateCodeEn-label" id="stateCodeEn-select" value={formData.stateCodeEn} label="State*">
        ...
        <Dialog open={false} onClose={() => {}}>
          ...
          <DialogContent>{/* Dialog content can be structured similarly to the main form */}</DialogContent>
          <DialogActions>
