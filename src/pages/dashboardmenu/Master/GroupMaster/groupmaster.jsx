        ...
        <Box component="form">
          ...
          >
              ...
              <Grid container spacing={3}>
                <Grid item xs={3}>
                  <FormControl fullWidth variant="outlined">
                    ...
                    <Select labelId="creator-label" id="creator-select" value={formValues.creator} label="Select Creator">
                ...
                <Grid item xs={12} md={3}>
                  <FormControl fullWidth>
                    ...
                    <Select labelId="branch-code-label" value={formValues.branchCode}>
                ...
                <Grid item xs={12} md={3}>
                  <TextField id="groupCode" label="Group Code" variant="outlined" fullWidth value={formValues.groupCode} />
                </Grid>
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <Grid container spacing={3}>
                {['groupName', 'villageName', 'centerName', 'cso', 'bmCode', 'preGRT', 'grt'].map((field, index) => (
            ...
            <Box sx={{ textAlign: 'center', mt: 4 }}>
              <Typography variant="h6" sx={{ fontWeight: 'bold', mb: 2, color: '#444' }}>
                ⚡ Actions
              </Typography>
